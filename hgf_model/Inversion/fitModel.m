...
% - hgf_binary3l_facial_verbal_config        (M1: Architecture A, no gamma)
% - hgf_binary3l_facial_verbal_gamma_config  (M4: gamma free)
if nargin > 2 && ~isempty(varargin{1})
    r.c_prc = eval(varargin{1});
else
    r.c_prc = hgf_binary3l_facial_verbal_config;
end
...
if nargin > 3 && ~isempty(varargin{2})
    ...
    r.c_obs = softmax_facial_verbal_config;
end
...
[nlj_val, rval, logLl, logPrcPrior, logObsPrior] = obj_fun(r.optim.argMin');
